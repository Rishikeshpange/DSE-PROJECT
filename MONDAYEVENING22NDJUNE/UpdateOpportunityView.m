...
-(void)UpdateOptyNotificationFound:(NSNotification*)notification
{
    ...
    {
        UIAlertView *alertView=[[UIAlertView alloc]initWithTitle:@"Oppurtunity Updated Successfully!" message:[NSString stringWithFormat:@"Integration Id:%@",IntegrationId_string] delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        alertView.tag=20;
        [alertView show];
